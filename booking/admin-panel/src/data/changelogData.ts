...
export const CHANGELOG: ChangelogVersion[] = [
  ...
  },
  {
    ...
    changes: [
      {
        type: "improvement",
        text: "Versionsnummer fuer VPS-Deploy auf v2.3.397 erhoeht.",
      },
    ],
  },
  {
    ...
    changes: [
      {
        type: "improvement",
        text: "Versionsnummer fuer VPS-Deploy auf v2.3.396 erhoeht.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      { type: "fix", text: "Deploy-Script als separate Datei (kein Heredoc in Funktion) + Rollback robuster" },
    ],
  },
  {
    version: "2.3.388",
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        text: "Dark-Mode / Light-Mode / Auto vollständig über CSS-Variablen gesteuert – FOUC-Fix in index.html.",
      },
      {
        type: "improvement",
  ...
  },
  {
    ...
    changes: [
      {
        type: "feature",
        text: "Einheitliches Kunden-Portal: Dashboard, Touren, Rechnungen, Team.",
      },
      {
        type: "feature",
        text: "Neue Rollen tour_manager, customer_admin, customer_user; Sidebar passt Navigation dynamisch an.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: "fix",
        text: "booking/access-rbac.js erkennt RBAC-Tabellen jetzt im aktiven Schema-Search-Path statt nur in public.",
      },
      {
        type: "fix",
        text: "booking/migrations/047 legt benoetigte system_roles vor den role_permissions idempotent an. Behebt FK-Startfehler auf aelteren Installationen.",
      },
    ],
  },
  {
    ...
    changes: [
      {
        type: "fix",
        text: "deploy-vps.ps1: kein cmd.exe-Pipe mehr; tar -> tmp -> scp -> ssh. Behebt Spawn-Fehler im Cursor-Agent.",
      },
    ],
  },
  {
