        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 border-[var(--border-soft)]">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
              config.enabled ? "bg-[var(--accent)]" : "bg-slate-200 bg-[var(--surface-raised)]"
            }`}
          >
            <span
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 text-[var(--text-subtle)] hover:text-[var(--text-muted)] transition-colors"
                >
