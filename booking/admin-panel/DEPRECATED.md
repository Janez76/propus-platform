...
unsichtbar geblieben — siehe `booking/admin-panel/AUDIT-2026-04.md` (Nachtrag
am Ende).
...
- [`AGENTS.md`](../../AGENTS.md) — verbindliche Architektur-Regeln seit April
  2026
- [`booking/admin-panel/AUDIT-2026-04.md`](./AUDIT-2026-04.md) — Audit des
  Orders-Refactorings inkl. Post-Audit-Nachtrag zur Deprecation
