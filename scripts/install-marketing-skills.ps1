...
if (-not (Test-Path $InstallRoot)) {
    ...
    Write-Host "OK Erstellt: $InstallRoot" -ForegroundColor Green
}
...
Write-Host ""
Write-Host "OK $($plugin.name) v$($plugin.version) - $skillCount Skills bereit" -ForegroundColor Green
...
if (Test-Path $JunctionPath) {
    ...
    Write-Host "OK Junction angelegt: $JunctionPath" -ForegroundColor Green
...
Write-Host ""
Write-Host "Update spaeter: einfach dieses Script erneut ausfuehren." -ForegroundColor DarkGray
