...
*Zuletzt aktualisiert: April 2026 (PR #94: §17 API-Key-Erstellung nutzt Username-Lookup statt numerische ID; Admin-Panel SPA-Auslieferung via express.static). PR #91: §17 API-Key-Verwaltung CRUD. PR #89: §16 Rate-Limiting & Security-Header, helmet. PR #88: §15 Kunden-Profil-Vorausfüllung via /auth/profile*
