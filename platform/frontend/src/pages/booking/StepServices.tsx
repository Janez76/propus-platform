      ...
      >
        <span className="min-w-0 flex-1">
          ...
          {category.description && (
            <span className="ml-2 text-xs font-normal text-[var(--text-subtle)]">{category.description}</span>
          )}
        </span>
    ...
    <div className="space-y-6">
      ...
      {categories.length > 0 && (
        <section>
          ...
          {hasKeyPickup && (
            <div className="mt-3 rounded-lg border border-[var(--accent)]/30 bg-[var(--accent)]/5 p-4 space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className={cn(
                    "w-full rounded-lg border px-3 py-2 text-sm text-[var(--text-main)] resize-y",
                    "border-[var(--border-soft)] bg-[var(--surface)]",
                    "focus:outline-none focus:ring-1 focus:ring-[var(--accent)]/30",
                    "placeholder:text-[var(--text-subtle)]",
                  )}
