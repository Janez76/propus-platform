...
const logLevel = (import.meta.env.VITE_LOG_LEVEL || (import.meta.env.DEV ? "debug" : "info")) as FrontendLogLevel;
const remoteLogLevel = (import.meta.env.VITE_LOG_REMOTE_LEVEL || "warn") as FrontendLogLevel;
const remoteEnabled = import.meta.env.PROD || String(import.meta.env.VITE_LOG_REMOTE || "false") === "true";
