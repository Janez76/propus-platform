          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin-bottom:10px;">
            <tr style="background:#f9fafb;border-radius:14px;">
              ...
              <td style="padding:13px 16px;vertical-align:middle;white-space:nowrap;">
                <a href="{{weiterfuehrenUrl}}" style="display:inline-block;padding:10px 22px;border-radius:999px;background-color:#7A5E10;background:linear-gradient(135deg,#8a6c18 0%,#5e470d 100%);color:#fff;text-decoration:none;font-size:13px;font-weight:700;box-shadow:0 3px 10px rgba(122,94,16,0.45);mso-padding-alt:0;line-height:1.4;">&#10003;&nbsp;Weiterführen</a>
              </td>
            </tr>
          </table>
