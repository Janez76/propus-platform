...
import { manifestToGalleryItems } from "../demo/demoTypes.ts";
import { fetchManifestFromUrl } from "../demo/fetchManifest.ts";
import {
  listMediaFromNextcloudPublicShare,
  nextcloudThumbUrlCandidates,
  parseNextcloudPublicShareUrl,
} from "../demo/nextcloudShare.ts";
import { randomUUID } from "../lib/randomId.ts";
import { pathClientGallery } from "../paths.ts";
import {
