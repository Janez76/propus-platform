...
import { deleteGallery, listGalleries, publicGalleryUrl, type GalleryListRow } from "../galleryApi.ts";
import { GalleryDeleteConfirmModal } from "./GalleryDeleteConfirmModal.tsx";
