...
import { GalleryFeedbackMailModal } from "./GalleryFeedbackMailModal.tsx";
import { GalleryRueckfrageModal } from "./GalleryRueckfrageModal.tsx";
import { GallerySendMailModal } from "./GallerySendMailModal.tsx";
import "./gallery-bildauswahl-editor.css";
import {
...
import type { ClientGalleryRow, GalleryFeedbackRow, GalleryImageRow, GalleryStatus } from "../types.ts";
...
export function GalleryEditorPage() {
  ...
  return (
    <div className="gbe-page">
      ...
      {mailOpen && g ? (
        <GallerySendMailModal gallery={g} onClose={() => setMailOpen(false)} onRecordedSent={() => void load()} />
      ) : null}
      {revisionMailFeedback && g ? (
        <GalleryFeedbackMailModal
          gallery={g}
