    ...
    <div className="space-y-4">
      ...
      {activeTab === "scheduling" ? (
        <div className="space-y-3 rounded-xl border border-[var(--border-soft)] bg-[var(--surface)] p-4">
          ...
          <div className="rounded-lg border border-[var(--border-soft)] p-3 border-[var(--border-soft)]">
          ...
          <div className="rounded-lg border border-[var(--border-soft)] p-3 border-[var(--border-soft)]">
            ...
            <label className="mt-3 flex cursor-pointer items-start gap-3 rounded-lg border border-[var(--border-soft)] p-3 border-[var(--border-soft)]">
              <input
                type="checkbox"
                className="mt-0.5"
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {schedulingHolidays.length === 0 ? (
                ...
                schedulingHolidays.map((date) => (
                  <span
                    key={date}
                    className="inline-flex items-center gap-2 rounded-full border border-[var(--border-soft)] px-2.5 py-1 text-xs border-[var(--border-soft)]"
                  >
                    {date}
          ...
          <div className="rounded-xl border border-[var(--border-soft)] bg-[var(--surface)] p-4">
            <div className="mb-3 flex items-start justify-between gap-3">
              ...
              {activePhotographers.length > 0 && (
                <span className="cust-badge cust-badge--neutral text-xs shrink-0">
      ...
      {activeTab === "reviews" ? (
        <div className="space-y-4 rounded-xl border border-[var(--border-soft)] bg-[var(--surface)] p-4">
          ...
          <label className="block text-sm">
            ...
            <input
              type="url"
              className="cust-form-input mt-1 w-full rounded px-3 py-2 text-sm"
