...
export function BildauswahlRueckfrageModal({ gallery, customerComment, onClose, onSaved }: Props) {
  ...
  const selectedTpl = templates.find((t) => t.id === BILDAUSWAHL_FOLLOWUP_TEMPLATE_ID) ?? null;
