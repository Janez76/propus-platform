                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm border-[var(--border-soft)] bg-[var(--surface)]">
                  ...
                  <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                    <button
                      ...
                      className="group flex w-64 flex-col items-center gap-3 rounded-2xl border-2 border-slate-200 bg-slate-50 px-6 py-8 transition hover:border-[var(--accent)] hover:bg-amber-50/50 border-[var(--border-soft)] bg-[var(--surface)] dark:hover:border-[var(--accent)] dark:hover:bg-amber-950/20"
                    >
