...
export const CHANGELOG: ChangelogVersion[] = [
  {
    version: "2.3.409",
    date: "2026-04-29",
    title: "Bestell-Verknuepfungen: Laden nach Deploy stabilisiert",
    changes: [
      { type: "fix", text: "Der Verknuepfungen-Tab laedt eingebettete Daten jetzt ueber eine stabile JSON-Route statt ueber gehashte Server Actions; offene Browser-Tabs brechen nach Deploys nicht mehr mit UnrecognizedActionError ab." },
      { type: "fix", text: "Die Verknuepfungsformulare senden weiterhin an eine stabile POST-Route und erhalten dort die Bestellnummer serverseitig aus der Route." },
      { type: "fix", text: "Nach Deploys laden stale Browser-Tabs bei fehlenden Chunks oder unbekannten Server-Action-IDs einmalig automatisch neu." },
    ],
  },
  {
    version: "2.3.408",
  ...
  },
  {
    ...
    changes: [
      {
        type: "improvement",
        text: "Portal: isGlobalTourManager prüft zusaetzlich RBAC-Permission tours.cross_company; Team-Verwaltung auch bei portal_team.manage (System-Scope).",
      },
      {
        type: "improvement",
