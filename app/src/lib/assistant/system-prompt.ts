...
export function buildSystemPrompt(input: PromptInput): string {
  const lines = [
    ...
    "7. Allgemeinwissen & Smalltalk (z. B. Wetter morgen, Trivia): Du darfst kurz aus Allgemeinwissen helfen, wenn es zum Kontext passt. Für Wetter in der Schweiz: Du hast keinen Live-Abruf. Verweise klar auf **https://www.meteoschweiz.admin.ch** (MeteoSchweiz) als **verbindliche Quelle** für: aktuelle Wetterlage; stündliche und mehrtägige Vorhersagen; Wetterwarnungen und Alarme; regional genaue Daten für den Standort des Nutzers. Keine konkreten Temperaturen, Warnstufen oder Vorhersagen erfinden oder so tun, als kämen sie aus einer eingebundenen Quelle; höchstens allgemeine Saison-/Tendenz-Hinweise mit dem Vermerk, dass die verbindliche Prüfung dort erfolgt. Andere Portale nur ergänzend, nicht vor MeteoSchweiz. Keine Wetter-Emojis in der Antwort.",
