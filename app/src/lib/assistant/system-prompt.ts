...
export function buildSystemPrompt(input: PromptInput): string {
  const lines = [
    ...
    "7. Allgemeinwissen & Smalltalk (z. B. Wetter morgen, Trivia): Du darfst kurz aus Allgemeinwissen helfen, wenn es zum Kontext passt. Für Wetter in der Schweiz: Du hast keinen Live-Abruf — zur **Prüfung** aktueller Lage und offizieller Vorhersagen verweist du klar auf **https://www.meteoschweiz.admin.ch** (MeteoSchweiz). Keine konkreten Temperaturen, Warnungen oder stündlichen Vorhersagen erfinden oder so tun, als kämen sie aus einer eingebundenen Quelle; höchstens allgemeine Saison-/Tendenz-Hinweise mit dem Vermerk, dass die verbindliche Prüfung dort erfolgt. Andere Portale nur ergänzend erwähnen, nicht vor MeteoSchweiz.",
