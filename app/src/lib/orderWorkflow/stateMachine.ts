 ...
 * Liberale Admin-Matrix: alle Bucket-zu-Bucket-Drags zulaessig.
 */
const ALLOWED: Record<string, string[]> = {
  [ORDER_STATUS.PENDING]: [
    ORDER_STATUS.PROVISIONAL, ORDER_STATUS.DISPOSITION_OFFEN, ORDER_STATUS.CONFIRMED,
    ORDER_STATUS.PAUSED, ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
    ORDER_STATUS.DONE, ORDER_STATUS.COMPLETED,
  ],
  [ORDER_STATUS.PROVISIONAL]: [
    ORDER_STATUS.CONFIRMED, ORDER_STATUS.DISPOSITION_OFFEN, ORDER_STATUS.PAUSED,
    ORDER_STATUS.COMPLETED, ORDER_STATUS.DONE, ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.DISPOSITION_OFFEN]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.PROVISIONAL, ORDER_STATUS.CONFIRMED,
    ORDER_STATUS.PAUSED, ORDER_STATUS.COMPLETED, ORDER_STATUS.DONE,
    ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.PAUSED]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.PROVISIONAL, ORDER_STATUS.DISPOSITION_OFFEN,
    ORDER_STATUS.CONFIRMED, ORDER_STATUS.COMPLETED, ORDER_STATUS.DONE,
    ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.CONFIRMED]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.PROVISIONAL, ORDER_STATUS.DISPOSITION_OFFEN,
    ORDER_STATUS.COMPLETED, ORDER_STATUS.DONE, ORDER_STATUS.PAUSED,
    ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.COMPLETED]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.CONFIRMED, ORDER_STATUS.DONE,
    ORDER_STATUS.PAUSED, ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.DONE]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.CONFIRMED, ORDER_STATUS.COMPLETED,
    ORDER_STATUS.PAUSED, ORDER_STATUS.CANCELLED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.CANCELLED]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.CONFIRMED, ORDER_STATUS.COMPLETED,
    ORDER_STATUS.DONE, ORDER_STATUS.PAUSED, ORDER_STATUS.ARCHIVED,
  ],
  [ORDER_STATUS.ARCHIVED]: [
    ORDER_STATUS.PENDING, ORDER_STATUS.CONFIRMED, ORDER_STATUS.COMPLETED,
    ORDER_STATUS.DONE, ORDER_STATUS.PAUSED, ORDER_STATUS.CANCELLED,
  ],
};
